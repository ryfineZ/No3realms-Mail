const en = {
	emptyDomain: 'Domain cannot be empty',
	domainAlreadyExist: 'Domain already exists',
	domainNotExist: 'Domain does not exist',
	domainNotVerified: 'Domain is not verified',
	dnsCredentialRequired: 'Cloudflare API Token is required',
	dnsProviderNotSupported: 'Domain is not hosted on Cloudflare, auto-config not supported',
