const zh = {
	emptyDomain: '域名不能为空',
	domainAlreadyExist: '该域名已存在',
	domainNotExist: '域名不存在',
	domainNotVerified: '域名未验证，无法操作',
	dnsCredentialRequired: '请提供 Cloudflare API Token',
	dnsProviderNotSupported: '该域名不在 Cloudflare 托管，暂不支持自动配置',
	IncorrectPwd: '密码输入错误',
